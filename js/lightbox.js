var propLightbox = {
	imgCard: document.getElementsByClassName('lightbox'),
	image: null,
	imageSRC: null,
...
var metLightbox = {
	effect: function () {
		for (var i = 0; i < propLightbox.imgCard.length; i++) {
			propLightbox.imgCard[i].addEventListener('click', metLightbox.selectImg);
		}
	},
	selectImg: function () {
